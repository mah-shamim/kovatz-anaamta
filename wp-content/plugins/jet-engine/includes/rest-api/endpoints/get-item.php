<?php
/**
 * Get JetEngine component/module item endpoint
 */
class Jet_Engine_Rest_Get_Item extends Jet_Engine_Base_API_Endpoint {
	...
	public function callback( $request ) {
		...
		$res = apply_filters( 'jet-engine/rest-api/get-item/' . $instance, false, $params, $this );

...
class AddNamedRangeRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddNamedRangeRequest::class, 'ElementskitVendor\\Google_Service_Sheets_AddNamedRangeRequest');

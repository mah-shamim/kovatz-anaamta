...
class DataSourceObjectReference extends \ElementskitVendor\Google\Model
{
    public $chartId;
...
\class_alias(DataSourceObjectReference::class, 'ElementskitVendor\\Google_Service_Sheets_DataSourceObjectReference');

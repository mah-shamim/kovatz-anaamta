...
class DataSourceFormula extends \ElementskitVendor\Google\Model
{
...
\class_alias(DataSourceFormula::class, 'ElementskitVendor\\Google_Service_Sheets_DataSourceFormula');

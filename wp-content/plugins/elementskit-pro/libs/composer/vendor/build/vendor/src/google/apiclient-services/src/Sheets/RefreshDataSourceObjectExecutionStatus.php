...
class RefreshDataSourceObjectExecutionStatus extends \ElementskitVendor\Google\Model
{
...
\class_alias(RefreshDataSourceObjectExecutionStatus::class, 'ElementskitVendor\\Google_Service_Sheets_RefreshDataSourceObjectExecutionStatus');

 ...
 */
namespace ElementskitVendor\phpseclib3\Crypt\EC\BaseCurves;
...
use ElementskitVendor\phpseclib3\Math\PrimeField;
use ElementskitVendor\phpseclib3\Math\BigInteger;
use ElementskitVendor\phpseclib3\Crypt\EC\Curves\Curve25519;
use ElementskitVendor\phpseclib3\Math\PrimeField\Integer as PrimeInteger;
/**
 * Curves over y^2 = x^3 + a*x + x
 *
 * @package EC
    ...
    public function setBasePoint($x, $y)
    {
        switch (\true) {
            case !$x instanceof BigInteger && !$x instanceof PrimeInteger:
                throw new \UnexpectedValueException('ElementskitVendor\\Argument 1 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
            case !$y instanceof BigInteger && !$y instanceof PrimeInteger:
                throw new \UnexpectedValueException('ElementskitVendor\\Argument 2 passed to Prime::setBasePoint() must be an instance of either BigInteger or PrimeField\\Integer');
        }
        if (!isset($this->factory)) {
            throw new \RuntimeException('setModulo needs to be called before this method');
        }

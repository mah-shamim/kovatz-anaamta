...
class AddProtectedRangeResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddProtectedRangeResponse::class, 'ElementskitVendor\\Google_Service_Sheets_AddProtectedRangeResponse');

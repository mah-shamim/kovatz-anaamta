...
class FindReplaceResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(FindReplaceResponse::class, 'ElementskitVendor\\Google_Service_Sheets_FindReplaceResponse');

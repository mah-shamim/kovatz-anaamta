...
class SpreadsheetProperties extends \ElementskitVendor\Google\Model
{
    public $autoRecalc;
...
\class_alias(SpreadsheetProperties::class, 'ElementskitVendor\\Google_Service_Sheets_SpreadsheetProperties');

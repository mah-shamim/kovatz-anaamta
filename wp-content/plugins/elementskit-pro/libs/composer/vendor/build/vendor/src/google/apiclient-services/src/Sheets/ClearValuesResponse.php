...
class ClearValuesResponse extends \ElementskitVendor\Google\Model
{
    public $clearedRange;
...
\class_alias(ClearValuesResponse::class, 'ElementskitVendor\\Google_Service_Sheets_ClearValuesResponse');

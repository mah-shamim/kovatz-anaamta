...
class GetSpreadsheetByDataFilterRequest extends \ElementskitVendor\Google\Collection
{
...
\class_alias(GetSpreadsheetByDataFilterRequest::class, 'ElementskitVendor\\Google_Service_Sheets_GetSpreadsheetByDataFilterRequest');

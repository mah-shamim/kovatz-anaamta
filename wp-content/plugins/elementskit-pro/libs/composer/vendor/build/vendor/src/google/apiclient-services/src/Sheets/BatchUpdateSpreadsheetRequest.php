...
class BatchUpdateSpreadsheetRequest extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BatchUpdateSpreadsheetRequest::class, 'ElementskitVendor\\Google_Service_Sheets_BatchUpdateSpreadsheetRequest');

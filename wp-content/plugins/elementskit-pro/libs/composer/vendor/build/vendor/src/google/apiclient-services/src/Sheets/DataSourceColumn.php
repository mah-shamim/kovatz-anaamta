...
class DataSourceColumn extends \ElementskitVendor\Google\Model
{
    public $formula;
...
\class_alias(DataSourceColumn::class, 'ElementskitVendor\\Google_Service_Sheets_DataSourceColumn');

...
class DeleteRangeRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(DeleteRangeRequest::class, 'ElementskitVendor\\Google_Service_Sheets_DeleteRangeRequest');

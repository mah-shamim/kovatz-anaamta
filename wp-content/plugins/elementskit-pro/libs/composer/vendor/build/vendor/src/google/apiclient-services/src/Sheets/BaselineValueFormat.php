...
class BaselineValueFormat extends \ElementskitVendor\Google\Model
{
...
\class_alias(BaselineValueFormat::class, 'ElementskitVendor\\Google_Service_Sheets_BaselineValueFormat');

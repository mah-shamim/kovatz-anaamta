...
class MatchedValueRange extends \ElementskitVendor\Google\Collection
{
...
\class_alias(MatchedValueRange::class, 'ElementskitVendor\\Google_Service_Sheets_MatchedValueRange');

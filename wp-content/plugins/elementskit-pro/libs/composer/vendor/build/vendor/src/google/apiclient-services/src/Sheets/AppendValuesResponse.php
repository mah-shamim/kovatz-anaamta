...
class AppendValuesResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(AppendValuesResponse::class, 'ElementskitVendor\\Google_Service_Sheets_AppendValuesResponse');

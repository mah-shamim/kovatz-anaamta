...
class SpreadsheetTheme extends \ElementskitVendor\Google\Collection
{
...
\class_alias(SpreadsheetTheme::class, 'ElementskitVendor\\Google_Service_Sheets_SpreadsheetTheme');

...
class UpdateNamedRangeRequest extends \ElementskitVendor\Google\Model
{
    public $fields;
...
\class_alias(UpdateNamedRangeRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateNamedRangeRequest');

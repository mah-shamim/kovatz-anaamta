...
class EmbeddedObjectPosition extends \ElementskitVendor\Google\Model
{
    public $newSheet;
...
\class_alias(EmbeddedObjectPosition::class, 'ElementskitVendor\\Google_Service_Sheets_EmbeddedObjectPosition');

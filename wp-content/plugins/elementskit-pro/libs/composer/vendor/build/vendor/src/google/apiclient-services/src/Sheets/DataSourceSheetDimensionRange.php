...
class DataSourceSheetDimensionRange extends \ElementskitVendor\Google\Collection
{
...
\class_alias(DataSourceSheetDimensionRange::class, 'ElementskitVendor\\Google_Service_Sheets_DataSourceSheetDimensionRange');

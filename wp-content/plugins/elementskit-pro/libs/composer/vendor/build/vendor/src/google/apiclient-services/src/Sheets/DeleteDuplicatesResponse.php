...
class DeleteDuplicatesResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(DeleteDuplicatesResponse::class, 'ElementskitVendor\\Google_Service_Sheets_DeleteDuplicatesResponse');

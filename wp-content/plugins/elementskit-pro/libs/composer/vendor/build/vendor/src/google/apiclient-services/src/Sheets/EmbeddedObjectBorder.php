...
class EmbeddedObjectBorder extends \ElementskitVendor\Google\Model
{
...
\class_alias(EmbeddedObjectBorder::class, 'ElementskitVendor\\Google_Service_Sheets_EmbeddedObjectBorder');

...
class InsertDimensionRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(InsertDimensionRequest::class, 'ElementskitVendor\\Google_Service_Sheets_InsertDimensionRequest');

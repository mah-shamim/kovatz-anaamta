...
class TreemapChartColorScale extends \ElementskitVendor\Google\Model
{
...
\class_alias(TreemapChartColorScale::class, 'ElementskitVendor\\Google_Service_Sheets_TreemapChartColorScale');

...
class AddChartResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddChartResponse::class, 'ElementskitVendor\\Google_Service_Sheets_AddChartResponse');

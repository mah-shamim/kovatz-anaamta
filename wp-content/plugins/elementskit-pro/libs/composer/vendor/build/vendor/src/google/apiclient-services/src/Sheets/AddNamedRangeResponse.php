...
class AddNamedRangeResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddNamedRangeResponse::class, 'ElementskitVendor\\Google_Service_Sheets_AddNamedRangeResponse');

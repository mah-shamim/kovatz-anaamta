...
class CopyPasteRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(CopyPasteRequest::class, 'ElementskitVendor\\Google_Service_Sheets_CopyPasteRequest');

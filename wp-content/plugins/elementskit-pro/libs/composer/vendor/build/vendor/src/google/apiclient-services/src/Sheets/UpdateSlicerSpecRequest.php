...
class UpdateSlicerSpecRequest extends \ElementskitVendor\Google\Model
{
    public $fields;
    public $slicerId;
...
\class_alias(UpdateSlicerSpecRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateSlicerSpecRequest');

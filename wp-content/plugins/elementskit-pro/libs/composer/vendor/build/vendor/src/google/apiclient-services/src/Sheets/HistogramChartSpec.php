...
class HistogramChartSpec extends \ElementskitVendor\Google\Collection
{
...
\class_alias(HistogramChartSpec::class, 'ElementskitVendor\\Google_Service_Sheets_HistogramChartSpec');

...
class RefreshDataSourceResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(RefreshDataSourceResponse::class, 'ElementskitVendor\\Google_Service_Sheets_RefreshDataSourceResponse');

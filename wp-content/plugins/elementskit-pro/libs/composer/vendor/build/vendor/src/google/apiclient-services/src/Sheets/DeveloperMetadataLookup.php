...
class DeveloperMetadataLookup extends \ElementskitVendor\Google\Model
{
...
\class_alias(DeveloperMetadataLookup::class, 'ElementskitVendor\\Google_Service_Sheets_DeveloperMetadataLookup');

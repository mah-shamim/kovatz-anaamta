...
class AddBandingResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddBandingResponse::class, 'ElementskitVendor\\Google_Service_Sheets_AddBandingResponse');

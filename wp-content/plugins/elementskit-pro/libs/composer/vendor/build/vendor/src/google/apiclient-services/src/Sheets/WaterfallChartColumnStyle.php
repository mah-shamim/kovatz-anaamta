...
class WaterfallChartColumnStyle extends \ElementskitVendor\Google\Model
{
...
\class_alias(WaterfallChartColumnStyle::class, 'ElementskitVendor\\Google_Service_Sheets_WaterfallChartColumnStyle');

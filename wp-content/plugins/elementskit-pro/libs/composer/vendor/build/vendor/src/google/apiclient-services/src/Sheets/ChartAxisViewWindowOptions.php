...
class ChartAxisViewWindowOptions extends \ElementskitVendor\Google\Model
{
...
\class_alias(ChartAxisViewWindowOptions::class, 'ElementskitVendor\\Google_Service_Sheets_ChartAxisViewWindowOptions');

 ...
 */
namespace ElementskitVendor\phpseclib3\Crypt\EC\Formats\Keys;

use ElementskitVendor\phpseclib3\Math\BigInteger;
use ElementskitVendor\phpseclib3\Crypt\Common\Formats\Keys\PKCS8 as Progenitor;
use ElementskitVendor\phpseclib3\File\ASN1;
use ElementskitVendor\phpseclib3\File\ASN1\Maps;
use ElementskitVendor\phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use ElementskitVendor\phpseclib3\Math\Common\FiniteField\Integer;
...
abstract class PKCS8 extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        if (!$params) {
            throw new \RuntimeException('ElementskitVendor\\Unable to decode the parameters using Maps\\ECParameters');
        }
        $components = [];

...
use ElementskitVendor\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use ElementskitVendor\GuzzleHttp\Promise\Promise;
use ElementskitVendor\GuzzleHttp\Promise\RejectedPromise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('ElementskitVendor\\GuzzleHttp\\Promise\\Promise')) {

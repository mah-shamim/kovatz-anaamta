...
use ElementskitVendor\Monolog\Formatter\LineFormatter;
...
use ElementskitVendor\PhpConsole\Connector;
use ElementskitVendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use ElementskitVendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('ElementskitVendor\\PhpConsole\\Connector')) {

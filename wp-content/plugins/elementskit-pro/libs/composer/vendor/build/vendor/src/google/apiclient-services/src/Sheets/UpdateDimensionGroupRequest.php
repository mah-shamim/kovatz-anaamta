...
class UpdateDimensionGroupRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(UpdateDimensionGroupRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateDimensionGroupRequest');

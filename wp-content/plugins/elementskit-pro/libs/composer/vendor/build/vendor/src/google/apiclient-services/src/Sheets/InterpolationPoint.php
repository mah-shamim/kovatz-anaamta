...
class InterpolationPoint extends \ElementskitVendor\Google\Model
{
...
\class_alias(InterpolationPoint::class, 'ElementskitVendor\\Google_Service_Sheets_InterpolationPoint');

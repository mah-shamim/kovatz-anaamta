...
class TreemapChartSpec extends \ElementskitVendor\Google\Model
{
...
\class_alias(TreemapChartSpec::class, 'ElementskitVendor\\Google_Service_Sheets_TreemapChartSpec');

...
use ElementskitVendor\GuzzleHttp\Cookie\CookieJar;
use ElementskitVendor\GuzzleHttp\Exception\GuzzleException;
 ...
 * @final
 */
class Client implements ClientInterface, \ElementskitVendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**

...
class BasicChartSeries extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BasicChartSeries::class, 'ElementskitVendor\\Google_Service_Sheets_BasicChartSeries');

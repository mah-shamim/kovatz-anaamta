...
class ScorecardChartSpec extends \ElementskitVendor\Google\Model
{
...
\class_alias(ScorecardChartSpec::class, 'ElementskitVendor\\Google_Service_Sheets_ScorecardChartSpec');

...
class DeleteDeveloperMetadataResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(DeleteDeveloperMetadataResponse::class, 'ElementskitVendor\\Google_Service_Sheets_DeleteDeveloperMetadataResponse');

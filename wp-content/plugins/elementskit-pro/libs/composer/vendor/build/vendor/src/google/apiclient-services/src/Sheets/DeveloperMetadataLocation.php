...
class DeveloperMetadataLocation extends \ElementskitVendor\Google\Model
{
...
\class_alias(DeveloperMetadataLocation::class, 'ElementskitVendor\\Google_Service_Sheets_DeveloperMetadataLocation');

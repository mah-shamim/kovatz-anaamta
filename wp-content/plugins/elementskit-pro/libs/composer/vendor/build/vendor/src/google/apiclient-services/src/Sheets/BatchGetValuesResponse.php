...
class BatchGetValuesResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BatchGetValuesResponse::class, 'ElementskitVendor\\Google_Service_Sheets_BatchGetValuesResponse');

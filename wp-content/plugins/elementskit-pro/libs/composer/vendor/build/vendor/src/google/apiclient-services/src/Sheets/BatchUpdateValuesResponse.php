...
class BatchUpdateValuesResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BatchUpdateValuesResponse::class, 'ElementskitVendor\\Google_Service_Sheets_BatchUpdateValuesResponse');

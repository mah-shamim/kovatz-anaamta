...
class AddSlicerResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddSlicerResponse::class, 'ElementskitVendor\\Google_Service_Sheets_AddSlicerResponse');

...
class DataSourceSpec extends \ElementskitVendor\Google\Collection
{
...
\class_alias(DataSourceSpec::class, 'ElementskitVendor\\Google_Service_Sheets_DataSourceSpec');

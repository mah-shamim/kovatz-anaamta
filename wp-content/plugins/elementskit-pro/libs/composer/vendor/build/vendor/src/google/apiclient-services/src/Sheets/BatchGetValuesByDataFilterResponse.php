...
class BatchGetValuesByDataFilterResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BatchGetValuesByDataFilterResponse::class, 'ElementskitVendor\\Google_Service_Sheets_BatchGetValuesByDataFilterResponse');

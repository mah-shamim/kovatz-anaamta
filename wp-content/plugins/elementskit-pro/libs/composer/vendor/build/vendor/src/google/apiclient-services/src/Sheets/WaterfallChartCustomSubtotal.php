...
class WaterfallChartCustomSubtotal extends \ElementskitVendor\Google\Model
{
...
\class_alias(WaterfallChartCustomSubtotal::class, 'ElementskitVendor\\Google_Service_Sheets_WaterfallChartCustomSubtotal');

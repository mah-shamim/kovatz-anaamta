...
class UpdateSpreadsheetPropertiesRequest extends \ElementskitVendor\Google\Model
{
    public $fields;
...
\class_alias(UpdateSpreadsheetPropertiesRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateSpreadsheetPropertiesRequest');

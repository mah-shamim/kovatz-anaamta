...
class BatchGetValuesByDataFilterRequest extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BatchGetValuesByDataFilterRequest::class, 'ElementskitVendor\\Google_Service_Sheets_BatchGetValuesByDataFilterRequest');

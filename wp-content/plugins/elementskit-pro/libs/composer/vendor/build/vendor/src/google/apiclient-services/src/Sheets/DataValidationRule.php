...
class DataValidationRule extends \ElementskitVendor\Google\Model
{
...
\class_alias(DataValidationRule::class, 'ElementskitVendor\\Google_Service_Sheets_DataValidationRule');

...
class DataFilterValueRange extends \ElementskitVendor\Google\Collection
{
...
\class_alias(DataFilterValueRange::class, 'ElementskitVendor\\Google_Service_Sheets_DataFilterValueRange');

...
class BatchUpdateValuesByDataFilterResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BatchUpdateValuesByDataFilterResponse::class, 'ElementskitVendor\\Google_Service_Sheets_BatchUpdateValuesByDataFilterResponse');

...
class BatchUpdateValuesByDataFilterRequest extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BatchUpdateValuesByDataFilterRequest::class, 'ElementskitVendor\\Google_Service_Sheets_BatchUpdateValuesByDataFilterRequest');

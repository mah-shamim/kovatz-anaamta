...
class UpdateConditionalFormatRuleResponse extends \ElementskitVendor\Google\Model
{
    public $newIndex;
...
\class_alias(UpdateConditionalFormatRuleResponse::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateConditionalFormatRuleResponse');

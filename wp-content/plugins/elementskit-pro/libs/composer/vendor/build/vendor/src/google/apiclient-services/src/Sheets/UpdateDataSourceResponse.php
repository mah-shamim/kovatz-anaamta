...
class UpdateDataSourceResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(UpdateDataSourceResponse::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateDataSourceResponse');

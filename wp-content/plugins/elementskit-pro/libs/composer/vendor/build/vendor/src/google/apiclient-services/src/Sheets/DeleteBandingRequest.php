...
class DeleteBandingRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(DeleteBandingRequest::class, 'ElementskitVendor\\Google_Service_Sheets_DeleteBandingRequest');

...
class AddSlicerRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddSlicerRequest::class, 'ElementskitVendor\\Google_Service_Sheets_AddSlicerRequest');

...
class UpdateBandingRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(UpdateBandingRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateBandingRequest');

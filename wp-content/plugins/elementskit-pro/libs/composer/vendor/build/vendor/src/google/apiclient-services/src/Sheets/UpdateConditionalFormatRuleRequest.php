...
class UpdateConditionalFormatRuleRequest extends \ElementskitVendor\Google\Model
{
    public $index;
    public $newIndex;
...
\class_alias(UpdateConditionalFormatRuleRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateConditionalFormatRuleRequest');

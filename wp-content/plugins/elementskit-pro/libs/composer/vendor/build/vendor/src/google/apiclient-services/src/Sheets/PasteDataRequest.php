...
class PasteDataRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(PasteDataRequest::class, 'ElementskitVendor\\Google_Service_Sheets_PasteDataRequest');

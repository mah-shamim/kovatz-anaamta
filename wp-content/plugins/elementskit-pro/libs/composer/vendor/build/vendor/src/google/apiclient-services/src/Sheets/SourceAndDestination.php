...
class SourceAndDestination extends \ElementskitVendor\Google\Model
{
    public $dimension;
    public $fillLength;
...
\class_alias(SourceAndDestination::class, 'ElementskitVendor\\Google_Service_Sheets_SourceAndDestination');

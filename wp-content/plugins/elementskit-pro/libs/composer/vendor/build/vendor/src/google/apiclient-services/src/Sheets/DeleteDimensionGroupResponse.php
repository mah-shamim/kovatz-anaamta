...
class DeleteDimensionGroupResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(DeleteDimensionGroupResponse::class, 'ElementskitVendor\\Google_Service_Sheets_DeleteDimensionGroupResponse');

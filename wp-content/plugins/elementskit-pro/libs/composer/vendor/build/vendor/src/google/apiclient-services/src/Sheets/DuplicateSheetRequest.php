...
class DuplicateSheetRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(DuplicateSheetRequest::class, 'ElementskitVendor\\Google_Service_Sheets_DuplicateSheetRequest');

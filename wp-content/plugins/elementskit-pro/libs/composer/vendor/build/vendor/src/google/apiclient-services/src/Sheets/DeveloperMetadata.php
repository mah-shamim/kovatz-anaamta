...
class DeveloperMetadata extends \ElementskitVendor\Google\Model
{
...
\class_alias(DeveloperMetadata::class, 'ElementskitVendor\\Google_Service_Sheets_DeveloperMetadata');

...
class UpdateEmbeddedObjectPositionRequest extends \ElementskitVendor\Google\Model
{
    public $fields;
...
\class_alias(UpdateEmbeddedObjectPositionRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateEmbeddedObjectPositionRequest');

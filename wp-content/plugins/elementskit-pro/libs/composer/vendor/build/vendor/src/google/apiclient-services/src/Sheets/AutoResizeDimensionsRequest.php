...
class AutoResizeDimensionsRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(AutoResizeDimensionsRequest::class, 'ElementskitVendor\\Google_Service_Sheets_AutoResizeDimensionsRequest');

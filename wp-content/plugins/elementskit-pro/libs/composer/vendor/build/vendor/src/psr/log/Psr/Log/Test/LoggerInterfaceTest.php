...
namespace ElementskitVendor\Psr\Log\Test;

use ElementskitVendor\Psr\Log\LoggerInterface;
use ElementskitVendor\Psr\Log\LogLevel;
use ElementskitVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('ElementskitVendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('ElementskitVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('ElementskitVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }

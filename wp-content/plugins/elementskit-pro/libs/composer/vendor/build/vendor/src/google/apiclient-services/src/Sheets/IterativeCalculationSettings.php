...
class IterativeCalculationSettings extends \ElementskitVendor\Google\Model
{
...
\class_alias(IterativeCalculationSettings::class, 'ElementskitVendor\\Google_Service_Sheets_IterativeCalculationSettings');

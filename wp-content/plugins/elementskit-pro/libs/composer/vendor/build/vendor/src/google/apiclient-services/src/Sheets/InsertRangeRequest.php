...
class InsertRangeRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(InsertRangeRequest::class, 'ElementskitVendor\\Google_Service_Sheets_InsertRangeRequest');

...
class AddDataSourceResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddDataSourceResponse::class, 'ElementskitVendor\\Google_Service_Sheets_AddDataSourceResponse');

...
class BatchUpdateValuesRequest extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BatchUpdateValuesRequest::class, 'ElementskitVendor\\Google_Service_Sheets_BatchUpdateValuesRequest');

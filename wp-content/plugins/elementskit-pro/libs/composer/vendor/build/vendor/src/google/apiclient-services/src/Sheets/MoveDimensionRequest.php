...
class MoveDimensionRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(MoveDimensionRequest::class, 'ElementskitVendor\\Google_Service_Sheets_MoveDimensionRequest');

...
class PivotGroupSortValueBucket extends \ElementskitVendor\Google\Collection
{
...
\class_alias(PivotGroupSortValueBucket::class, 'ElementskitVendor\\Google_Service_Sheets_PivotGroupSortValueBucket');

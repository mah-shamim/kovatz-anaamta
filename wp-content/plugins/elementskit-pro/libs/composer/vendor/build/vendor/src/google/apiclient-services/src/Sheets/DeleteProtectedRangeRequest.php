...
class DeleteProtectedRangeRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(DeleteProtectedRangeRequest::class, 'ElementskitVendor\\Google_Service_Sheets_DeleteProtectedRangeRequest');

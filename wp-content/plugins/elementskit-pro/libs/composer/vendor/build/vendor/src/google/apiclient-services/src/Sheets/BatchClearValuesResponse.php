...
class BatchClearValuesResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(BatchClearValuesResponse::class, 'ElementskitVendor\\Google_Service_Sheets_BatchClearValuesResponse');

...
class DuplicateSheetResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(DuplicateSheetResponse::class, 'ElementskitVendor\\Google_Service_Sheets_DuplicateSheetResponse');

...
class UpdateProtectedRangeRequest extends \ElementskitVendor\Google\Model
{
    public $fields;
...
\class_alias(UpdateProtectedRangeRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateProtectedRangeRequest');

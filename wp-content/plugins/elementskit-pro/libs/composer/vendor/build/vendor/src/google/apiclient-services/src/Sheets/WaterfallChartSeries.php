...
class WaterfallChartSeries extends \ElementskitVendor\Google\Collection
{
...
\class_alias(WaterfallChartSeries::class, 'ElementskitVendor\\Google_Service_Sheets_WaterfallChartSeries');

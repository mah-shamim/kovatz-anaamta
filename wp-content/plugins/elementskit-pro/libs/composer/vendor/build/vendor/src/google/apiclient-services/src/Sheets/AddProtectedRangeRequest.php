...
class AddProtectedRangeRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddProtectedRangeRequest::class, 'ElementskitVendor\\Google_Service_Sheets_AddProtectedRangeRequest');

...
class MatchedDeveloperMetadata extends \ElementskitVendor\Google\Collection
{
...
\class_alias(MatchedDeveloperMetadata::class, 'ElementskitVendor\\Google_Service_Sheets_MatchedDeveloperMetadata');

...
class CopySheetToAnotherSpreadsheetRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(CopySheetToAnotherSpreadsheetRequest::class, 'ElementskitVendor\\Google_Service_Sheets_CopySheetToAnotherSpreadsheetRequest');

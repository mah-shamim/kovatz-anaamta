...
class DataSourceChartProperties extends \ElementskitVendor\Google\Model
{
...
\class_alias(DataSourceChartProperties::class, 'ElementskitVendor\\Google_Service_Sheets_DataSourceChartProperties');

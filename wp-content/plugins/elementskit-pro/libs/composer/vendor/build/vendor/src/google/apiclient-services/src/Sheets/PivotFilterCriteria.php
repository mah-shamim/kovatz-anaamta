...
class PivotFilterCriteria extends \ElementskitVendor\Google\Collection
{
...
\class_alias(PivotFilterCriteria::class, 'ElementskitVendor\\Google_Service_Sheets_PivotFilterCriteria');

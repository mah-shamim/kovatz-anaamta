...
class SetDataValidationRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(SetDataValidationRequest::class, 'ElementskitVendor\\Google_Service_Sheets_SetDataValidationRequest');

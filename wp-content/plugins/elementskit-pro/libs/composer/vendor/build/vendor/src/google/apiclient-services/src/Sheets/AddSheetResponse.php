...
class AddSheetResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddSheetResponse::class, 'ElementskitVendor\\Google_Service_Sheets_AddSheetResponse');

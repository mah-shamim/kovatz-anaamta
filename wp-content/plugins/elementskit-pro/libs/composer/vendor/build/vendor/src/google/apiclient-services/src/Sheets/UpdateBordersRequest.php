...
class UpdateBordersRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(UpdateBordersRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateBordersRequest');

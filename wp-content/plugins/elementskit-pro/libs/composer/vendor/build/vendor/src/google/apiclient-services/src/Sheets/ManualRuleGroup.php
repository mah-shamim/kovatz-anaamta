...
class ManualRuleGroup extends \ElementskitVendor\Google\Collection
{
...
\class_alias(ManualRuleGroup::class, 'ElementskitVendor\\Google_Service_Sheets_ManualRuleGroup');

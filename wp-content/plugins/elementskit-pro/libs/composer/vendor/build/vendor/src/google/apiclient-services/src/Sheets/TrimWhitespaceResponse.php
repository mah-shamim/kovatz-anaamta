...
class TrimWhitespaceResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(TrimWhitespaceResponse::class, 'ElementskitVendor\\Google_Service_Sheets_TrimWhitespaceResponse');

...
class TextToColumnsRequest extends \ElementskitVendor\Google\Model
{
    public $delimiter;
...
\class_alias(TextToColumnsRequest::class, 'ElementskitVendor\\Google_Service_Sheets_TextToColumnsRequest');

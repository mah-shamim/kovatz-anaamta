...
class FilterCriteria extends \ElementskitVendor\Google\Collection
{
...
\class_alias(FilterCriteria::class, 'ElementskitVendor\\Google_Service_Sheets_FilterCriteria');

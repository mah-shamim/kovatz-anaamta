...
class AddDimensionGroupResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(AddDimensionGroupResponse::class, 'ElementskitVendor\\Google_Service_Sheets_AddDimensionGroupResponse');

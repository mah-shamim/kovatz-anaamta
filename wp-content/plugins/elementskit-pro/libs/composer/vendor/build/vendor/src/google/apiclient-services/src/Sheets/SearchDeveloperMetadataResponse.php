...
class SearchDeveloperMetadataResponse extends \ElementskitVendor\Google\Collection
{
...
\class_alias(SearchDeveloperMetadataResponse::class, 'ElementskitVendor\\Google_Service_Sheets_SearchDeveloperMetadataResponse');

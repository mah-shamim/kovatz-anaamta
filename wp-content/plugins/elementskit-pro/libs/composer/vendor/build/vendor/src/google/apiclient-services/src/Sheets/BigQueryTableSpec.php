...
class BigQueryTableSpec extends \ElementskitVendor\Google\Model
{
    public $datasetId;
    public $tableId;
...
\class_alias(BigQueryTableSpec::class, 'ElementskitVendor\\Google_Service_Sheets_BigQueryTableSpec');

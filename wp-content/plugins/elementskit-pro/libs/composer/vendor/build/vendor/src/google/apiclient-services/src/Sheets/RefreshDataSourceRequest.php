...
class RefreshDataSourceRequest extends \ElementskitVendor\Google\Model
{
    public $dataSourceId;
    public $force;
    public $isAll;
...
\class_alias(RefreshDataSourceRequest::class, 'ElementskitVendor\\Google_Service_Sheets_RefreshDataSourceRequest');

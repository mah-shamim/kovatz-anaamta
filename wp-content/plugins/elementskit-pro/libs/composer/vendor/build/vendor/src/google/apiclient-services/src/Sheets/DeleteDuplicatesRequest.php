...
class DeleteDuplicatesRequest extends \ElementskitVendor\Google\Collection
{
...
\class_alias(DeleteDuplicatesRequest::class, 'ElementskitVendor\\Google_Service_Sheets_DeleteDuplicatesRequest');

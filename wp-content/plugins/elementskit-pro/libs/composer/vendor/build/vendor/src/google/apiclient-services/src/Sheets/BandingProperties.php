...
class BandingProperties extends \ElementskitVendor\Google\Model
{
...
\class_alias(BandingProperties::class, 'ElementskitVendor\\Google_Service_Sheets_BandingProperties');

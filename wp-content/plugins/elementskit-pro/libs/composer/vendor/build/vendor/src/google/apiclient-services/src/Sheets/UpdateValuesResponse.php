...
class UpdateValuesResponse extends \ElementskitVendor\Google\Model
{
...
\class_alias(UpdateValuesResponse::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateValuesResponse');

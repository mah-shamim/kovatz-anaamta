...
class ProtectedRange extends \ElementskitVendor\Google\Collection
{
...
\class_alias(ProtectedRange::class, 'ElementskitVendor\\Google_Service_Sheets_ProtectedRange');

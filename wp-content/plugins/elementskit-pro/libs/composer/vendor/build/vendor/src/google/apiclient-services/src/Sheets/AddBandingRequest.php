...
class AddBandingRequest extends \ElementskitVendor\Google\Model
{
...
\class_alias(AddBandingRequest::class, 'ElementskitVendor\\Google_Service_Sheets_AddBandingRequest');

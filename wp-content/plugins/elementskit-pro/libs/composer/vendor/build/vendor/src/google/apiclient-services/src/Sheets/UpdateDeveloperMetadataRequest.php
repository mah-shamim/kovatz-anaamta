...
class UpdateDeveloperMetadataRequest extends \ElementskitVendor\Google\Collection
{
...
\class_alias(UpdateDeveloperMetadataRequest::class, 'ElementskitVendor\\Google_Service_Sheets_UpdateDeveloperMetadataRequest');

...
class DataSourceSheetProperties extends \ElementskitVendor\Google\Collection
{
...
\class_alias(DataSourceSheetProperties::class, 'ElementskitVendor\\Google_Service_Sheets_DataSourceSheetProperties');

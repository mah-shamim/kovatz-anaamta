...
class OAuthSignatureMethod_HMAC_SHA1 extends OAuthSignatureMethod
{
	...
	public function build_signature( $request, $consumer, $token )
	{
		...
		$base_string          = preg_replace_callback( "/(%[A-Za-z0-9]{2})/", function($matches){return strtolower($matches[0]);}, $base_string ); //convert base string to lowercase
		...
		$key       = preg_replace_callback( "/(%[A-Za-z0-9]{2})/", function($matches){return strtolower($matches[0]);}, $key ); //convert to lowercase
